...
:::tip
The screenshots use the Adwaita theme. Your theme and version of Shelly may look different, since Shelly is under active development. However, the functionality remains the same.
:::
