...
<Aside type="caution">
  `Super+1..9` are reserved by the workspace bindings. For direct layout
  switches prefer the slot-based `set_layout_*` builtins (`Super+T/F/M/G`) or
  non-conflicting chords like `Super+Alt+T`.
</Aside>
