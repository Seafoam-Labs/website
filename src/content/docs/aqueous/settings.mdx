...
maximize. Snap zones `a` through `d` have normalized coordinate editors,
previews, and half/third/quarter presets.
...
both chord and verb and can be created or deleted; a snap-zone preset produces
the correct `builtin:snap_zone:<a-d>` form. The page also edits launcher,
terminal, screenshot, and lock commands.
