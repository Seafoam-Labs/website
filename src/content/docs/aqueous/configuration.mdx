...
[instance paths](/aqueous/desktop-session/#stable-and-git-instance-paths).
...
Pearl uses the canonical `aqueous-config` backend for compositor configuration.
...
[Settings and configuration helper](/aqueous/settings/).
