...
A window rule can set `scrolling_full_width = true` to start its column at full
viewport width. Manual toggles and horizontal resizing override the preset;
see [Scrolling width rules](/aqueous/window-rules/#scrolling-width-rules).
...
instead of swapping axes. See [Keybindings](/aqueous/keybindings/#scrolling-actions).
